...
# 举例
string = "the objectives of this subject are to introduce students to the concepts and applications of discrete mathematical structures and help students attain the fundamental mathematical knowledge and reasoning skills they need to be successful in upperlevel computing subjects".replace(
    " ", "")
